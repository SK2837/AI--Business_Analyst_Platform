...
class Report(Base):
    ...
    visualizations = Column(JSONB, nullable=True, default=list)
    ...
    report_metadata = Column(JSONB, nullable=True, default=dict)  # Renamed from 'metadata' to avoid SQLAlchemy conflict
